      ...
      <div className="flex-1 lg:ml-[240px]">
        ...
        <main className="p-4 sm:p-6 space-y-6">
          <div>
            ...
            <p className="text-white/70">Automate your sales process with AI</p>
          </div>
          
          {/* AI Sales Agent content will be added here */}
          <div className="bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.1)] p-8 rounded-lg flex items-center justify-center">
            <p className="text-white/50">AI Sales Agent functionality will be implemented soon</p>
          </div>
        </main>
      </div>
    </div>
